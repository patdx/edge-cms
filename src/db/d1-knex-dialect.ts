...
export class Client_CloudflareD1 extends Client_SQLite3 {
  _driver() {
  ...
  async acquireRawConnection() {
    return this.config.CLOUDFLARE_DB;
...
Object.assign(Client_CloudflareD1.prototype, {
  // The "dialect", for reference .
  driverName: "cloudflare-d1",
});
